...
namespace BeatSaberBackUpTool.Models
{
    public class MainWindowDomain : BindableBase
    {
        ...
        // private string FileName => DateTime.Now.ToString("BSBackUp_yyyyMMddhhmmss");
        #endregion
        //ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*
        #region // コマンド
        #endregion
        ...
        //ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*
        #region // プライベートメソッド
        private async void Create(Action<string, string> func, string frompass, string topass)
        {
            this.IsCreating = true;
            try {
                await this.dispatcher_?.InvokeAsync(() => func?.Invoke(frompass, topass));
                this.DialogService?.ShowDialog(nameof(DialogView), new DialogParameters() { { "Messege", "作成に成功しました。" } }, _ => { });
            }
            catch(Exception e) {
        ...
        {
            try {
                this.Create(ZipFile.CreateFromDirectory, this.FromPass, this.ToPass);
            }
            catch (Exception e) {
                this.Logger.Error(e);
                return false;
        ...
        //ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*
        #region // 構築・破棄
        public MainWindowDomain(IDialogService service)
        {
            this.IsCreating = false;
